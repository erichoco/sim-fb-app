...
public class PullToRefreshListView extends ListView implements OnScrollListener {
    ...
    private String taglog1 = "refreshing";
    private String taglog2 = "loading";
    ...
    private void init(Context context) {
        ...
        /** "Pull to Load More" initialization **/
        footerInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        footer = (RelativeLayout) footerInflater.inflate(R.layout.footer_layout, this, false);
        loadingMore = (ProgressBar) footer.findViewById(R.id.loading_more);
            ...
            case MotionEvent.ACTION_MOVE:
                if (previousY != -1) {
                    ...
                    if (newHeaderPadding != headerPadding && state != State.REFRESHING) {
                        ...
                        if (state == State.PULL_TO_REFRESH && headerPadding > 20) {
                            setState(State.RELEASE_TO_REFRESH);
                            image.clearAnimation();
                            image.startAnimation(flipAnimation);
                        } else if (state == State.RELEASE_TO_REFRESH && headerPadding < 20) {
                            setState(State.PULL_TO_REFRESH);
                            image.clearAnimation();
    ...
    private void bounceBackHeader() {
        ...
        /*
        String refreshingornot;
        if (state == State.REFRESHING)
        	refreshingornot = "refreshing";
        else refreshingornot =  "not refreshing";  
        Log.d("Refresh Anim", "bouncing back");
        Log.d("Refresh Anim", refreshingornot + " bounce length: " + yTranslate);
        yTranslate += 50;
        */
    ...
    private class HeaderAnimationListener implements AnimationListener {
        ...
        public void onAnimationStart(Animation animation) {
            ...
            setLayoutParams(lp);
            //Log.d("Refresh Anim", "lp.height="+lp.height+" getHeight()="+getHeight());
        ...
        public void onAnimationEnd(Animation animation) {
            ...
            setSelection(0);
            //Log.d("Refresh Anim", "getTop()="+getTop()+" measuredHeaderHeight="+measuredHeaderHeight);
            android.view.ViewGroup.LayoutParams lp = getLayoutParams();
            lp.height = height;
            setLayoutParams(lp);
    ...
    /**
     * This part of code is used to implement "Pull to Load More" feature.
     * <p/>
     * <p/>
     * It is modified based on https://github.com/shontauro/android-pulltorefresh-and-loadmore
     * Edited by Chiu Po Tsung
     */
    ...
    public interface OnLoadMoreListener {
        /**
         * onLoadMore should be implemented in activity using this class
         */
    ...
    public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
        if (onLoadMoreListener != null) {
            ...
            if (!isLoadingMore && loadMore && (state != State.REFRESHING)
                    && currentScrollState != SCROLL_STATE_IDLE) {

                //Log.d(taglog2, "should load data");

                loadingMore.setVisibility(View.VISIBLE);
                isLoadingMore = true;

                /** A 1s delay is set here in order to see the loading circle **/
                postDelayed(new Runnable() {
